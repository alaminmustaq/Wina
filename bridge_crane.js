function chinese(){
  ...
  function translate_chinese(){
    ...
    var bridge_crane_link = document.querySelector(".bridge_crane_link")
    bridge_crane_link.textContent = "桥式起重机"

    var bridge_crane_text = document.querySelector(".bridge_crane_text")
    bridge_crane_text.textContent = "桥式起重机"
  ...
  function translate_english(){
    ...
    var bridge_crane_link = document.querySelector(".bridge_crane_link")
    bridge_crane_link.textContent = "Bridge Crane"

    var bridge_crane_text = document.querySelector(".bridge_crane_text")
    bridge_crane_text.textContent = "Bridge Crane"
