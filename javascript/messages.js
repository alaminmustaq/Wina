function chinese(){
  ...
  function translate_chinese(){
    ...
    var contact_link = document.querySelector(".message_link")
    contact_link.textContent = "留言"

    var contact_text = document.querySelector(".message_text")
    contact_text.textContent = "留言"

    var input_message = document.querySelector(".input_message")
    input_message.placeholder = "信息"
    ...
    input_email.placeholder = "电子邮件"

    var input_phone = document.querySelector(".input_phone")
    input_phone.placeholder = "电话"

    var message_submit_btn = document.querySelector(".message_submit_btn")
    message_submit_btn.textContent = "提交"
  ...
  function translate_english(){
    ...
    var contact_link = document.querySelector(".message_link")
    contact_link.textContent = "Messages"

    var contact_text = document.querySelector(".message_text")
    contact_text.textContent = "Messages"

    var input_message = document.querySelector(".input_message")
    input_message.placeholder = "Message"
    ...
    var input_phone = document.querySelector(".input_phone")
    input_phone.placeholder = "Phone"

    var message_submit_btn = document.querySelector(".message_submit_btn")
    message_submit_btn.textContent = "Submit"
