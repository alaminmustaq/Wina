function chinese(){
  ...
  function translate_chinese(){
    ...
    var chatagory_gantry_crane = document.querySelector(".chategory_contact_link")
    chatagory_gantry_crane.textContent = "联系人"
    chatagory_gantry_crane.href = chatagory_gantry_crane.href + "#ch"

    var chatagory_bridge_crane = document.querySelector(".chategory_message_link")
    chatagory_bridge_crane.textContent = "留言"
    ...
    contact_link.textContent = "联系人"

    var contact_text = document.querySelector(".contact_text")
    contact_text.textContent = "联系人"

    var body_address_text = document.querySelector(".body_address_text")
    body_address_text.textContent = "地址：中国河南省郑州市新村镇孙庄村107国道西环路南3号"

    var body_phone_num = document.querySelector(".body_phone_num")
    body_phone_num.textContent = "电话：+8801565166564"

    var body_email_add = document.querySelector(".body_email_add")
    body_email_add.textContent = "电子邮件：wina@gmail.com"
  ...
  function translate_english(){
    ...
    var chategory_contact_link = document.querySelector(".chategory_contact_link")
    chategory_contact_link.textContent = "Contact"
    chategory_contact_link.href = chategory_contact_link.href + "#eng"

    var chatagory_bridge_crane = document.querySelector(".chategory_message_link")
    chatagory_bridge_crane.textContent = "Messages"
    ...
    var contact_link = document.querySelector(".contact_link")
    contact_link.textContent = "Contacts"

    var contact_text = document.querySelector(".contact_text")
    contact_text.textContent = "Contact"

    var body_address_text = document.querySelector(".body_address_text")
    body_address_text.textContent = "Address: No. 3 South Side of Xihuanxiang Road, 107 National Road, Sunzhuang Village, Xincun Town, Zhengzhou City, Henan Province China."

    var body_phone_num = document.querySelector(".body_phone_num")
    body_phone_num.textContent = "Tel：+8801565166564"

    var body_email_add = document.querySelector(".body_email_add")
    body_email_add.textContent = "Email：wina@gmail.com"
  ...
  function replace_hash(before,after){
    ...
    var chategory_contact_link = document.querySelector(".chategory_contact_link")
    chategory_contact_link.href = chategory_contact_link.href.replace(before,after)

    var chategory_message_link = document.querySelector(".chategory_message_link")
    chategory_message_link.href = chategory_message_link.href.replace(before,after)
