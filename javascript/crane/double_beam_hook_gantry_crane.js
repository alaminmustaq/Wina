function chinese(){
  ...
  function translate_chinese(){
    ...
    var db_gantry_crane_text = document.querySelector(".db_gantry_crane_text")
    db_gantry_crane_text.textContent = "双梁钩门式起重机"

    var db_gantry_crane_def = document.querySelector(".db_gantry_crane_def")
    db_gantry_crane_def.textContent = "MG万能双梁吊钩门式起重机适用于露天仓库、堆场、铁路货站、港口码头等的装卸，也可配备多种专用吊钩进行各种特殊作业。"

    var db_gantry_crane_spec = document.querySelector(".db_gantry_crane_spec")
    db_gantry_crane_spec.textContent = "主要特点："

    var db_gantry_crane_spec_1 = document.querySelector(".db_gantry_crane_spec_1")
    db_gantry_crane_spec_1.textContent = "起重量：10至200吨"

    var db_gantry_crane_spec_2 = document.querySelector(".db_gantry_crane_spec_2")
    db_gantry_crane_spec_2.textContent = "跨度：7.5 至 50 米"

    var db_gantry_crane_spec_3 = document.querySelector(".db_gantry_crane_spec_3")
    db_gantry_crane_spec_3.textContent = "工作温度：-20℃至40℃"
  ...
  function translate_english(){
    ...
    var db_gantry_crane_text = document.querySelector(".db_gantry_crane_text")
    db_gantry_crane_text.textContent = "Double Beam Hook Gantry Crane"

    var db_gantry_crane_def = document.querySelector(".db_gantry_crane_def")
    db_gantry_crane_def.textContent = "MG universal double-beam hook gantry crane is suitable for loading and unloading of the open warehouse, stock yard, railway freight station, port wharf, etc. It can also be equipped with a variety of special hooks for a variety of special operations."

    var db_gantry_crane_spec = document.querySelector(".db_gantry_crane_spec")
    db_gantry_crane_spec.textContent = "Main Features:"

    var db_gantry_crane_spec_1 = document.querySelector(".db_gantry_crane_spec_1")
    db_gantry_crane_spec_1.textContent = "Lifting weight: 10 to 200 tons"

    var db_gantry_crane_spec_2 = document.querySelector(".db_gantry_crane_spec_2")
    db_gantry_crane_spec_2.textContent = "Span: 7.5 to 50 meters"

    var db_gantry_crane_spec_3 = document.querySelector(".db_gantry_crane_spec_3")
    db_gantry_crane_spec_3.textContent = "Working temperature: -20℃ to 40℃"
